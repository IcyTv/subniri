...
use iced::{
	Color, Element, Event, Length, Radians, Rectangle, Renderer, Size, Vector,
	advanced::{
		self, Layout, Shell, Widget, layout, mouse, renderer,
		widget::{Tree, tree},
	},
	widget::canvas,
	window,
...
use crate::{
	animation::easing::{EMPHASIZED, Easing},
	style::COLORS,
};
...
impl Animation {
	...
	fn with_elapsed(
		&self, cycle_duration: Duration, additional_rotation: u32, elapsed: Duration, now: Instant,
	) -> Self {
	...
	Message: 'a + Clone,
{
	...
	fn update(
		&mut self, tree: &mut Tree, event: &Event, _layout: Layout<'_>, _cursor: mouse::Cursor,
		_renderer: &Renderer, shell: &mut Shell<'_, Message>, _viewport: &Rectangle,
	) {
